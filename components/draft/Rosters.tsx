...
export default function Rosters() {
  ...
  if (teamsLoading || settingsLoading) return <div>Loading rosters...</div>;
  if (teamsError || settingsError)
    return <div>Error loading rosters: {teamsError || settingsError}</div>;
  if (!settings || !teams.length) return <div>No teams or settings found.</div>;
          ...
          >
            ...
            <CardContent>
              <Table>
                <TableHeader>
                  <TableRow>
                    <TableHead className="text-gray-50">Slot</TableHead>
                    <TableHead className="text-gray-50">Player</TableHead>
                    <TableHead className="text-gray-50">Price</TableHead>
                  </TableRow>
                </TableHeader>
                <TableBody>
                  {slots.map((slot, i) => {
